    ...
    <DocsLayout>
      <div className="space-y-8 animate-in fade-in duration-500">
        <div className="text-sm text-muted-foreground mb-4">
          Docs <span className="mx-2">/</span> Advanced Features <span className="mx-2">/</span> Heterogeneous Expert Parallelism
        </div>
...
--hetero-current-device-type H100`}</code>
          ...
          <h2>Expert Parallelism in Heterogeneous Environment</h2>
          <p>
          ...
          <h2>MoE Model Considerations</h2>
          <ul>
