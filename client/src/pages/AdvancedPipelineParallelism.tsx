...
export default function AdvancedPipelineParallelism() {
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <section className="space-y-4">
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Parameter Description</h3>
      ...
      <section className="space-y-4">
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Where</h3>
        <ul className="space-y-2 list-disc list-inside">
